      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div className="space-y-12">
          <div className="relative w-full h-64 md:h-80 rounded-2xl overflow-hidden shadow-xl animate-in fade-in slide-in-from-bottom-4 duration-700">
            <Image src="/team-collaboration-on-ai-technology-with-diverse-p.jpg" alt="Team collaboration" fill className="object-cover" />
          ...
          <div className="bg-card border border-border rounded-2xl p-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300 hover:shadow-xl transition-shadow">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="group">
                <div className="bg-muted/50 rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-105">
                  <div className="relative w-full h-48">
                    <Image src="/professional-portrait-of-data-scientist-rayen.jpg" alt="Rayen Bouallegue" fill className="object-cover" />
                  </div>
                  <div className="p-4">
              ...
              <div className="group">
                <div className="bg-muted/50 rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-105">
                  <div className="relative w-full h-48">
                    <Image src="/professional-portrait-of-data-scientist-sarra.jpg" alt="Sarra Mzali" fill className="object-cover" />
                  </div>
                  <div className="p-4">
              ...
              <div className="group">
                <div className="bg-muted/50 rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-105">
                  <div className="relative w-full h-48">
                    <Image src="/professional-portrait-of-data-scientist-nour.jpg" alt="Nour El Houda Zaabi" fill className="object-cover" />
                  </div>
                  <div className="p-4">
              ...
              <div className="group">
                <div className="bg-muted/50 rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-105">
                  <div className="relative w-full h-48">
                    <Image src="/professional-portrait-of-data-scientist-mohamed-sl.jpg" alt="Mohamed Slim Chouaib" fill className="object-cover" />
                  </div>
                  <div className="p-4">
